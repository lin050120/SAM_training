...
- オンライン学習データ拡張：[`docs/ONLINE_TRAINING_AUGMENTATION_JA.md`](docs/ONLINE_TRAINING_AUGMENTATION_JA.md)（English: [`docs/ONLINE_TRAINING_AUGMENTATION_EN.md`](docs/ONLINE_TRAINING_AUGMENTATION_EN.md)，中文: [`docs/ONLINE_TRAINING_AUGMENTATION_CN.md`](docs/ONLINE_TRAINING_AUGMENTATION_CN.md)）
...
同じページで「オフ/軽量/カスタム」のオンライン学習データ拡張を設定できます。幾何変換は画像と mask に同期して適用され、train のみに作用し、val、test、推論は変更しません。
